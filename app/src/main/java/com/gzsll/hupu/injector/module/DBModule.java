...
public class DBModule {
    ...
    @Singleton
    @Named("zhu")
   String provideContext(Context context) {//这个provideContext是服务于下个方法，xiaoming,xiaoming放在ApplicationComponent,等着MainPresenter关联使用。
//        return new DaoMaster.DevOpenHelper(context, "app.db", null);
    ...
    @Singleton
    @Named("fei")
    String xiaoming (@Named("zhu") String s) {
        return  s+ "是的";
    }
