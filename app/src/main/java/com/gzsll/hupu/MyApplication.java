...
public class MyApplication extends Application {
    ...
    UserDao mUserDao;
    @Inject
    OkHttpClient mOkHttpClient; //@Inject OkHttpClient mOkHttpClient;
    private ApplicationComponent mApplicationComponent;//ApplicationComponent mApplicationComponent;
