 ...
 */
@PerActivity//单例--@PerActivity说明该对象和activity生命周期一致
public class SplashPresenter implements SplashContract.Presenter {
    ...
    @Inject
    public SplashPresenter(Context mContext, OkHttpHelper mOkHttpHelper, int str,@Named("string")String ss) {//第八步
        //Context mContext,OkHttpHelper mOkHttpHelper是从别的地方依赖过来的
